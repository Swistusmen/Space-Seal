...
public class PipelineBuilder {
    ...
    static public String buildPipeline(String location){
        ...
        streamMKVAV1="filesrc location="+location+" ! qtdemux name=demux ! queue ! h264parse ! avdec_h264 ! av1enc ! matroskamux name=mux ! hlssink playlist-root=http://127.0.0.1:8080 max-files=100 playlist-length=0 demux. ! queue ! aacparse ! mux.";
