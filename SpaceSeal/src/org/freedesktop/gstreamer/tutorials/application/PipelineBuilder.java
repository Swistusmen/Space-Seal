...
public class PipelineBuilder {
    ...
    static public String buildPipeline(String location, StreammingProtocol protocol){
        ...
        if(StreammingProtocol.RTSP==protocol) {
            Log.i(Config.TAG, "RTSP AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        ...
        if(protocol==StreammingProtocol.HLS) {
            //This one streams mkv (av1,aac) http
